...
class Urteil(unittest.TestCase):
    ...
    def test_einzelner_unset_lauf_macht_ertrag_offen(self):
        ...
        self.assertEqual(t[Kennung("t1", "neu")]["urteil"]["art"], "ertrag-offen")
